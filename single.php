    ...
    <div id="main" class="post">
        ...
        <article itemprop="articleBody" id="post-<?php the_ID();?>">
    		...
    		<footer class="article-footer clearfix">
        		...
        		<div class="ds-share" data-thread-key="<?php the_ID();?>" data-title="<?php the_title();?>" data-images="null" data-content="<?php echo mb_strimwidth(strip_tags(apply_filters('the_content', $post->post_content)), 0, 150,"..."); ?>" data-url="<?php the_permalink();?>">
